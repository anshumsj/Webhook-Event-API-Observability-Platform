...
- 200 OK:      node scripts/mock-server.js success
- 500 Error:   node scripts/mock-server.js fail
- Timeout:     node scripts/mock-server.js timeout
- Retry Test:  node scripts/mock-server.js retry-test
  `);
});
